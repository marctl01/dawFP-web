                    ...
                    <div class="relative overflow-x-auto">
                        ...
                        <form action="{{ route('user.create' ) }}" method="post">
                            ...
                            <div class="flex mb-6">
                              ...
                              <div class="w-auto md:w-1/2 px-3 mb-6 md:mb-0">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="username">
                                  Nombre Usuario
                                </label>
                                <input name="username"class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="ufname" type="text" required>
                              </div>
                              <div class="w-auto md:w-1/2 px-3 mb-6 md:mb-0">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="email">
                                  Email
                                </label>
                                <input name="email"class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="ufname" type="text" required>
                              </div>
                              <div class="w-auto md:w-1/2 px-3 mb-6 md:mb-0">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="passw">
                                  Password
                                </label>
                                <input name="passw"class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="ufname" type="text" required>
                              </div>
                              ...
                              <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                ...
                                <div class="relative">
                                  <select name="rol" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="id_modulo">
                                    @foreach ($rols as $rol)
